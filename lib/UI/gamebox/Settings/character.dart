...
class Character extends State<CharacterPage> {
  ...
  Widget hairStyle() {
    return Row(
      children: <Widget>[
        ...
        Expanded(
          child: hairStyleImage("assets/gamebox/img/charactor/hairStyle/hair_style3.png", 1),
        ),
        SizedBox(
          width: 20,
        ),
        Expanded(
          child: hairStyleImage("assets/gamebox/img/charactor/hairStyle/hair_style2.png", 3),
        ),
        SizedBox(
          width: 20,
        ),
        Expanded(
          child: hairStyleImage("assets/gamebox/img/charactor/hairStyle/hair_style1.png", 2),
        ),
        SizedBox(
          width: 20,
        ),
  ...
  Widget hairStyleImage(String img, int idx) {
    return InkWell(
      child: Image.asset(
        img,
        fit: BoxFit.contain,
  ...
  Widget hat() {
    return Row(
      children: <Widget>[
        ...
        Expanded(
          child:hatImg("assets/gamebox/img/charactor/hat/hat3.png", 1)
        ),
        SizedBox(
          width: 20,
        ),
        Expanded(
            child:hatImg("assets/gamebox/img/charactor/hat/hat2.png", 2)
        ),
        SizedBox(
          width: 20,
        ),
        Expanded(
          child:hatImg("assets/gamebox/img/charactor/hat/hat1.png", 3)
        ),
        SizedBox(
          width: 20,
        ),
  ...
  Widget hatImg(String img, int idx) {
    return InkWell(
      child: Image.asset(
        img,
        fit: BoxFit.contain,
