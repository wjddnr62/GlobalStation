...
class QuizS extends StatefulWidget {
  ...
  QuizS({Key key, this.level, this.chapter, this.stage, this.question_num,this.title})
      : super(key: key);
...
class Silver extends State<QuizS> {
  @override
                    ...
                    child: Stack(
                      children: <Widget>[
                        Align(
                          ...
                          child: Image.asset(
                            "assets/gamebox/img/quiz/quiz_green.png",
                            fit: BoxFit.fill,
                            width: 300,
                            height: 310,
                          ),
  ...
  Widget answer(String answer,int num) {
    return Container(
      width: 100,
      height: 40,
      decoration: (clickAnswer == num)? quizSilverSelectBoxContainer : quizSilverBoxContainer,
      child: InkWell(
        onTap: (){
          setState(() {
            clickAnswer = num;
